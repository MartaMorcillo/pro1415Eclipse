...
public class _16Ventas {
    ...
    public static void distribuidorMasVentas(int v[][]){
        ...
        System.out.println("El distribuidor con más ventas es el " + (distMasVentas+1));
    }
    public static void articuloMasVentas(int v[][]){
        ...
        System.out.println("El articulo con más ventas es el " + (artMasVentas+1));
    ...
    public static void informeComisiones(int v[][], double p[]){
        for (int i = 0; i < v.length; i++) {
            ...
            if(comision > 0){
                ...
                System.out.println( "Vendedor: " + (i+1) + ". Total: "+ totalDistribuidor + " €. Porcentaje comision: " + comision + " %. Importe comision: " + importeComision + " €");
            }
        }
    }
}
